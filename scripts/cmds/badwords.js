module.exports = {
	...
	langs: {
		...
		en: {
			onText: "on",
			offText: "off",
			onlyAdmin: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nOnly admins can add banned words to the list\n────────\n",
			missingWords: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nYou haven't entered the banned words\n────────\n",
			addedSuccess: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nAdded %1 banned words to the list\n────────\n",
			alreadyExist: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\n%1 banned words already exist in the list before: %2\n────────\n",
			tooShort: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\n%1 banned words cannot be added to the list because they are shorter than 2 characters: %2\n────────\n",
			onlyAdmin2: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nOnly admins can delete banned words from the list\n────────\n",
			missingWords2: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nYou haven't entered the words to delete\n────────\n",
			deletedSuccess: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nDeleted %1 banned words from the list\n────────\n",
			notExist: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\n%1 banned words do not exist in the list before: %2\n────────\n",
			emptyList: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nThe list of banned words in your group is currently empty\n────────\n",
			badWordsList: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nThe list of banned words in your group: %1\n────────\n",
			onlyAdmin3: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nOnly admins can %1 this feature\n────────\n",
			turnedOnOrOff: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nBanned words warning has been %1\n────────\n",
			onlyAdmin4: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nOnly admins can delete banned words warning\n────────\n",
			missingTarget: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nYou haven't entered user ID or tagged user\n────────\n",
			notWarned: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nUser %1 has not been warned for banned words\n────────\n",
			removedWarn: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nUser %1 | %2 has been removed 1 banned words warning\n────────\n",
			warned: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nBanned words \"%1\" have been detected in your message, if you continue to violate you will be kicked from the group\n────────\n",
			warned2: "𝗕𝗮𝗱𝘄𝗼𝗿𝗱𝘀\n不適切な言葉\n────────\nBanned words \"%1\" have been detected in your message, you have violated 2 times and will be kicked from the group\n────────\n",
